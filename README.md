...
- **ショートカットへのファイル D&D 起動**: ZIP / CBZ / PDF / RAR / CBR / 7z / CB7 / LZH / LHA や通常のフォルダ・画像/動画ファイルを mImageViewer のショートカットへドラッグ＆ドロップ、または SendTo で送ると、その場所を開くようになりました。既に mImageViewer が起動中の場合も、既存ウィンドウを前面化してそのパスを開きます
