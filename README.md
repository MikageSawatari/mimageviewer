...
- **★フィルタのショートカット**: ツールバーの★フィルタを Ctrl+クリックで「その★のみ表示」、Shift+クリックで「その★以上を表示」に一発で切り替えられるように拡張。同じボタンを再度 Ctrl / Shift +クリックすると全 ON に戻るトグル。右クリックメニューでも同じ操作ができるようにし、覚えやすさを担保
