...
- **⚠️ 最大化したまま終了すると、次回も最大化で起動するようになりました。** Windows の一般的な動きに合わせています。最大化を解いたときは、これまでどおり終了時の位置とサイズに戻ります。更新直後の初回起動は通常のウィンドウのままで、次に最大化して終了したときから効きます。常に通常のウィンドウで起動したい場合は、環境設定 →「起動と連携」→「起動時の動作」で「通常ウィンドウ」を選んでください。常に最大化で起動することもできます。
