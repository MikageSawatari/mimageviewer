...
- **<kbd>R</kbd> / <kbd>L</kbd> で回転したページが、見開きで正しく単独表示されるようになりました。** 縦長のページを回転して横向きにすると、画面では横長なのに見開きの相手を探してしまい、2 ページ並べて表示していました。回転後の見た目で判断するようになり、本物の横長ページと同じく 1 ページで表示します。ブラウザからのリモート閲覧でも同じ組み合わせになります。
