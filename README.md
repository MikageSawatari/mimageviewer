...
- **シャープ化調整**: 画像補正パネルに「シャープ化」スライダーを追加しました。最終表示の段階で輪郭を中心に自然に強調するスマートシャープ方式で、平坦な部分のノイズや白黒のフチ浮きを強調しにくいのが特徴です。AI アップスケール後の画像にも掛かり、疑似カラーなどのポストフィルタとも併用できます。コピー・書き出しにも反映されます（サムネイルには反映されません）
