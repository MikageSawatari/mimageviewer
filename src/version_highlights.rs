    ...
    VersionHighlights {
        ...
        must_read: &[
            ...
            HighlightItem {
                ...
                body: "「全体」と「隣接のみ」で塗ったとき、境界に細い塗り残しが出ないよう、既定で 1px 外側まで塗るようになります。以前の塗り方に戻すには、バケツツールのはみ出し量を 0 にしてください。",
            },
            HighlightItem {
                title: "白黒・セピア原稿の消しゴム補完が既定で色を合わせます",
                body: "白黒やセピアの原稿を消しゴムで補完したとき、補完した部分だけ色味が浮かないよう、既定で周囲の色調に合わせるようになります。以前の仕上がりに戻すには、消しゴムの色調合わせを切ってください。",
            },
        ],
        highlights: &[
            HighlightItem {
