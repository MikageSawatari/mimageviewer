...
const TABLE: &[VersionHighlights] = &[
    ...
    VersionHighlights {
        ...
        highlights: &[HighlightItem {
            ...
            body: "X や Instagram に複数枚として投稿し、横にめくると全体で 1 枚の絵に見える投稿を作れます。全画面で画像補正パネルのいちばん右のアイコンから始めます。枠を動かして大きさを決め、パネルの「分割して書き出す」で書き出します。投稿先ごとに枠の比率と、画像と画像の間に隠れる帯の幅を合わせるので、めくったときに継ぎ目が繋がります。ファイル名の末尾に付く番号の順に添付してください。回転しているページでは使えません。",
        }],
    },
];
