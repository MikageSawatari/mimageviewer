    ...
    VersionHighlights {
        ...
        must_read: &[
            HighlightItem {
                ...
                body: "上部バーに増えたボタンを押すと開く一覧の中に入っています。この一覧には、これまでキーだけで画面上のボタンが無かった操作 (ナビゲータの 2 つの設定、ピクセルグリッド、ルーペの固定) もまとまっています。中身と並び順はカスタマイズできます。",
            },
            HighlightItem {
        ...
        highlights: &[
            ...
            HighlightItem {
                title: "環境設定を検索できます",
                body: "左のツリーの上にある入力欄に言葉を入れると、該当する設定項目が並びます。選ぶとそのページが開き、その項目までスクロールして数秒間ふちどりで示します。",
            },
            HighlightItem {
                title: "消しゴムと隠蔽加工の塗りつぶし (バケツ)",
                body: "ツールを「バケツ」(K) に切り替えると、クリックした色に近い範囲を一度に塗れます。平らな面をブラシでなぞる必要がなくなります。",
            },
            HighlightItem {
                title: "縦向きで撮った動画が正しい向きで再生されます",
                body: "スマートフォンで撮った動画など、回転の情報を持つ動画が、サムネイルと再生とで違う向きになっていました。フルスクリーンのシークバーには目盛りが出るようになり、再生位置をつかみやすくなっています。",
            },
        ],
    },
];
