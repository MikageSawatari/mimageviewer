    ...
    VersionHighlights {
        ...
        highlights: &[
            HighlightItem {
                ...
                body: "拡大表示中に Alt を押しているあいだ、画面の隅に全体の縮小画像と                       いま見えている範囲の枠が出ます。枠をドラッグして表示位置を動かせます。                       360度パノラマにも対応しています。",
            },
            HighlightItem {
                title: "ファイル名での絞り込み",
                body: "絞り込みバーの「ファイル名」欄で、今表示している一覧をファイル名で                       絞り込めます。先頭に - を付けた語は、含まないものが残ります。",
            },
            HighlightItem {
