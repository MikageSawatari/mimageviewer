        ...
        for window in &deferred_windows {
            ...
            ctx.show_viewport_deferred(viewport_id, builder, move |vp_ctx, _class| {
                ...
                if !minimized && let Some(outer) = outer_rect {
                    let placement = detached_placement_from_viewport_rects(
                        view.placement,
                        outer,
                        inner_rect,
                        maximized,
