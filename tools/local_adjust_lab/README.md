...
- RGB color parameters in Color Fill, Outline Stroke, Rim Light, Contact
  ...
  Light Leak, Backlight Haze, Lithograph, Engraving, Part Color, Halation, Toon Shade, Speed Lines, Cloud/Fog, Particle Overlay, Aurora, and Spotlight share a control with a color button,
...
- Effects with image-space center or light-source parameters can show canvas
  handles for direct dragging on the image. God Rays, Lens Flare, Light Leak, Backlight Haze, Spotlight,
