...
> 「`docs/archive/folders-archives/nested-zip-tree-review-brief.md` を読んで、この通りにレビューして」と指示するか、
...
- **正本ドキュメント**:
  ...
  - [docs/archive/folders-archives/nested-zip-test-guide.md](nested-zip-test-guide.md) — テスト ZIP とチェックリスト
