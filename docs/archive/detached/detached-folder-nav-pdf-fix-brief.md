...
関連: `docs/archive/detached/detached-folder-nav-pdf-claudecode-investigation-request.md` (依頼)、
`docs/archive/detached/detached-folder-nav-pdf-claudecode-investigation-report.md` (調査報告・**先に読むこと**)
...
- `src/app/tests.rs`
- `docs/archive/detached/detached-rework-stage-folder-nav.md` (§5 参照)
...
2. `docs/archive/detached/detached-rework-stage-folder-nav.md` に、
