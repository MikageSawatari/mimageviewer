# パフォーマンス調査 引き継ぎメモ (**一部は解決済み**)

> **2026-04-21 更新**: Ctrl+↑↓ 連打 / Ctrl+F / Ctrl+S / open_fullscreen の UI ブロック問題は
> 別の調査サイクルで特定・対処済み。経緯と設計方針は
> [../../ui-responsiveness.md](../../ui-responsiveness.md) にまとめた。本ドキュメントに残っている
> 「調査課題 1: AI アップスケール優先度」と「調査課題 2: スクロール中の重複エンキュー抑制」
> は未着手。
