...
- **docs/archive/ai/ai-model-facet-plan.md** — 機能B の正本
...
**正本: docs/archive/ai/ai-model-facet-plan.md。**
...
- **docs/compile-book-plan.md / ../ai/ai-model-facet-plan.md** のステータスを実装済みに更新。
- **docs/spec.md** の機能一覧。
