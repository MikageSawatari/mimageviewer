...
前回 ([docs/archive/vst3/codex-vst3-stutter-still-answer.md](codex-vst3-stutter-still-answer.md)) の Codex 助言通り、video pace_lead に `VIDEO_QUEUE_LEAD_CAP_SECS = 0.60` の cap を追加した:
