...
> 本書は `../ai/auto-mask-detection-plan.md` (Claude 案) ↔ `../ai/ai-suggested-mask-v1.1.0-plan.md`
...
13. **Codex のパイプライン再構成との整合** ([../editing/local-adjust-pipeline-refactor-plan.md](../editing/local-adjust-pipeline-refactor-plan.md)):
