...
`docs/archive/video/codex-native-overlay-redraw-cadence-brief.md`. The soak report includes
...
`docs/archive/video/codex-native-presenter-copy-spike-brief.md`. Setting
