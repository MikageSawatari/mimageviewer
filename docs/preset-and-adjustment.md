...
消しゴム描画ツール自身の Ctrl+ドラッグ:

- 筆: ドラッグ起点からの移動量で半径を調整
- 縦線/横線: 向きに沿う軸のドラッグで回転 (傾き)、直交軸のドラッグでパン

旧 Line ツールの Ctrl+ドラッグ複合操作 (水平=太さ / 垂直=回転) は廃止済み。
通常の直線の太さはスライダー / ホイール / 作成後のハンドルで調整する。
隠蔽加工側の描画ツールには Ctrl+ドラッグ調整はなく、筆/線のサイズは
スライダー / ホイール / 作成後のハンドルで調整する。
