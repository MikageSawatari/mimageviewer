...
前提: 2026-05-01 時点の未コミット差分、`docs/codex-vst3-seek-reset-brief.md`、`src/video/dsp/bridge.rs`、`crates/vst3-host/src/main.cpp`、`crates/vst3-host/src/audio_pipe.cpp` を確認した判断です。
