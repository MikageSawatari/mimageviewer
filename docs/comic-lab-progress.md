...
TyranoScript / JRPG / コミックキャプションを調査し、**設計書 [message-window-design.md]
(message-window-design.md) に確定**。要点:
...
## 本体統合メモ
- Codex が本体パイプライン再構成中(`docs/local-adjust-pipeline-refactor-plan.md`、edit pipeline /
