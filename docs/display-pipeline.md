...
| 対象 | ページ間隔 | 支配項 |
| --- | --- | --- |
| 合成 fixture 24MP JPEG (`generate_measure_fixture.py`) | 67ms | **フルサイズ upload 28.2ms** + デコード 172ms |
| 実物の本 (`-Setup` で用意、カラー化 + AI アップスケール有効) | — | **デコード 72.9ms** + AI タイル 57.5ms×44。upload は **1.38ms** しかない |
