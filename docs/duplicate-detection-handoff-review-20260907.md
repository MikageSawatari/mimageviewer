...
上記と§1〜§6はレビュー開始時点の記録。後続の担当体制・実装・検証・portable配布状況は
[レビュー修正記録](duplicate-detection-review-fixes-20260907.md) を正本とする。
v3.6.0統合は本書§7、R2/R3/R7/R9のportable更新と実機確認待ちは修正記録に記載した。
