...
| A / B / X / Y / Select / Start / LB / RB / LT / RT 単体 | 既定では上記のゲームパッド操作を行う。操作カスタマイズのゲームパッド図、またはコマンド一覧の編集ダイアログから、各文脈ごとに既定 / なし / 一発アクションへ差し替え可能。X 単体の割り当てを変えても X+方向リングは別スロットとして残る |
