...
- 静止画 / ZIP 内画像 / PDF ページと、その編集・補正・AI・注釈後の最終表示は、物理倍率が
  ...
  同じ可視領域と目標寸法を NIS で拡大する。物理 1.0 倍は
  ...
  縮小だけは引き続き Lanczos3 とする。Lanczos3 / シャープ拡大は一辺 8192px、総画素 4096×4096 相当までで、
...
- [x] **ポストフィルタ** (表示エフェクト、41 プリセット。うち 2 個は旧カラー化互換)
  - レトロ系:
    - 基本: 標準 / ニアレスト (補間なし) / シャープ拡大
