...
そのファイルを選択状態にする。ショートカットへのドラッグ＆ドロップや SendTo は
Windows が対象パスを位置引数として渡すため、この経路で処理する。
...
- [x] AI 画像メタデータ表示（PNG tEXt/iTXt/zTXt チャンク、JPEG EXIF UserComment。A1111 互換 / ComfyUI / NovelAI / InvokeAI / SwarmUI / Fooocus 系 / Midjourney 相当を正規化）
