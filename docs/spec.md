...
- サムネ / 詳細の両モード共通で、ツールバー下のスマートフィルタバーから
  種類・拡張子・場所・★・タグ・日付・サイズ・状態・AI モデル・生成ツールを絞り込める。
...
| `fullscreen_navigator_visible` | bool | false | 単ページ / 見開きの拡大中に、縮小画像と現在の表示範囲を示すナビゲータを表示する。全体表示中、連結読み、360度パノラマ、動画、比較、編集 / 分析モードでは実効的に非表示 |
