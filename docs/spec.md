...
- 動画はフルスクリーンでインライン再生。下部 HUD の速度ボタンから 0.5x〜3.0x の
  ...
  Shift+Enter で起動する。
- 動画の上部ホバーバーから、現在フレームをクリップボードへコピーできる。前/次
  フレームボタンまたは Ctrl+Shift+←/→ で 1 フレーム単位に移動し、移動後は
...
| 右 Ctrl（押している間） | 元画像プレビュー（mIV 側の補正/AI/消しゴム補完を一時的に外す） |
...
| Escape | 現在表示中の項目にカーソルを戻してフルスクリーンを閉じる |
