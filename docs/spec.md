...
グリッドの Backspace 親フォルダ移動と、グリッド / フルスクリーンの F11 系ウィンドウ切り替えも
...
お気に入り 1〜20、`C:\`〜`Z:\`、場所▼で開ける固定項目 (ドライブ一覧 / 読書履歴 /
★1〜★5 / 本棚フォルダ / デスクトップ / ピクチャ / ダウンロード) も一発アクションとして
割り当てられる。未登録のお気に入り番号や存在しないドライブを実行した場合はトーストで通知して
何もしない。
