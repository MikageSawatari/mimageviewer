...
| キー | 動作 |
|------|------|
| ? (既定) | 現在のサムネイル一覧コンテキストで使えるショートカット一覧を表示する。keymap 化済み操作は現在読み込まれている割り当てを表示し、固定扱いのナビゲーションキーとキー未設定 / 無効化中の操作は別枠で表示する |
...
| キー | 動作 |
|------|------|
| ? (既定) | 画像フルスクリーンで使えるショートカット一覧を表示する。keymap 化済み操作は現在読み込まれている割り当てを表示し、固定扱いのナビゲーションキーとキー未設定 / 無効化中の操作は別枠で表示する |
...
- **ショートカットヘルプ**: 補正レイヤーモード中は既定 `?` のヘルプキーで現在使えるショートカット一覧を表示し、
  `LocalAdjust` scope の keymap 割り当て、キー未設定 / 無効化中の操作、Esc / Enter /
