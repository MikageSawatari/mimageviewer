...
| `fullscreen_page_number_overlay` | bool | true | 静止画フルスクリーン右下に現在ページ / 総ページ数を常時表示する |
...
- [x] メニュー「タグ」: ピン留めタグの管理 / 選択中ファイルから mIV タグをクリア / 登録タグのワンクリックトグル
