...
| 製本 | 追加先の本に追加 (Ctrl+B) / 本棚フォルダを開く / 追加先の本を開く / この本を並べ替え / 製本の管理… / 追加先の本を選ぶ |
...
- トップレベルメニューのいずれかをクリックして開いている間は、`ファイル` /
  ...
  hover だけではメニューを開かない。
- 製本の「この本を並べ替え」は本フォルダ専用の並べ替えダイアログを開く。小サムネイルの
...
| `active_book_name` | String | `名前なし` | Ctrl+B / 製本メニューからページを追加する先の本名。製本ルート直下のフォルダ名として使う |
