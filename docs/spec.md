...
- フルスクリーンのテキストモードでは、ページ単位に非破壊の注釈オブジェクトを編集できる。
  種別は単体テキスト、吹き出し、メッセージウィンドウ、スタンプ。
- セリフ / 単体テキストは、フォント、サイズ、色、横書き / 縦書き、揃え、行間、字間、
...
- 吹き出しは、形状、塗り、輪郭、しっぽ、装飾、結合、文字に合わせた自動サイズを編集できる。
  メッセージウィンドウは、背景、枠、影、名前プレート、立ち絵枠、続き指標を編集できる。
- 注釈は表示と `Ctrl+E` 書き出しに焼き込まれる。サムネイルには焼き込まず、フルスクリーン編集
  / 書き出しの最前面オーバーレイとして扱う。
