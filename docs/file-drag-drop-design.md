...
- `docs/archive/release/feature-expansion-ideas.md` の「見送る機能」に **「ドラッグ送出 — 工数大、別議論」**
...
- **実ファイル**: 画像 / 動画 / ZIP 本体 / PDF 本体 / 変換前アーカイブ (RAR/7z/LZH 等)
- **実フォルダ**: グリッド上段のフォルダ
...
- ZIP 本体 / PDF 本体 / RAR / 7z をドラッグ → コピーされる。
