...
Status: 計画 v2.9（**Inc 3 完了** + **Inc 7 書き出し完了** + **Inc 6 変形ハンドル(回転/四隅
...
Inc 0/1/2/3/7 完了、Inc 6 の変形ハンドル部分完了。
...
(セリフ/本体/しっぽ・枠) + 左色帯に刷新 [本コミット]。次は Inc 4c スタンプ(絵文字同梱)・
オノマトペ → 編集用追加パック DL 基盤 → Inc 5 プリセット・フォント → Inc 6 Undo）
