...
依頼元: `docs/detached-folder-nav-pdf-claudecode-investigation-request.md`
...
> **internal folder-nav reopen と terminal close を区別する** (依頼書 §2 / `docs/detached-rework-stage-folder-nav.md`)
