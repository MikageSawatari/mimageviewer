...
> ステータス: **Phase 7 消しゴム / 隠蔽加工ヘルプスライス実装中 / レビュー待ち** (2026-06-24)。
...
>
> **Phase 7 消しゴム / 隠蔽加工ヘルプスライス実装メモ (2026-06-24, Codex 実装中)**:
...
> ホイールなどの固定扱い入力は補助行に分ける。動画フルスクリーン、テキスト注釈、
> 切り取り、補正レイヤーは後続。
...
- **消しゴム / 隠蔽加工ヘルプスライス実装中**: 消しゴム / 隠蔽加工モード中に `?` を押したとき、
