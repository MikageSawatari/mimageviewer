...
設計正本: [folder-representative-plan.md](folder-representative-plan.md)。§1.276 と共通の候補順・cache proof を採用。
...
設計正本: [folder-representative-plan.md](folder-representative-plan.md)。§1.275 と共通の候補順・cache proof を採用。
