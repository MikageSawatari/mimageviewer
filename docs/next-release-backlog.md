...
- [調査と修正記録](fullscreen-folder-sidecar-transition-investigation-20260913.md)。通常一覧・別context・取消/identity不一致の回帰と全体gate（本体8386成功/失敗0/ignored45、snapshot50成功）・確認build完了。独立静的レビューは重大指摘なし、最終証拠照合と利用者確認待ち。
