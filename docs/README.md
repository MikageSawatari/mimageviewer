...
| [web-remote-ai-plan.md](web-remote-ai-plan.md) | **段 3b-0〜3b-2 実装済み、3b-2 実機確認待ち**。remote AI アップスケール / デノイズの PC modal 排他、共有 canonical decoder、接続取得 / 切断 drain barrier、App 所有 singleton Runtime、stable remote key、HTTP job、Web UI、画面消灯復帰、VRAM、撤退条件 |
